...
export default function Navbar({show,toggleNavbar }) {
  console.log(show);
  ...
  return (
    <aside
    className={`fixed top-0 left-0 h-full bg-blue-800 p-4 text-white w-64 z-50 transform transition-transform duration-300 ease-in-out 
    ${show ? "translate-x-0" : "-translate-x-full"} md:translate-x-0 md:static md:w-auto`}
  >
     <div className="flex justify-between items-center mb-4">
        <Link href="/" className="flex gap-1 mr-4">
          <svg
